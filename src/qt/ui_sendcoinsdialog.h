...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QString::fromUtf8("0.00 ADZ"));
        ...
        labelCoinControlFee->setText(QString::fromUtf8("0.00 ADZ"));
        ...
        labelCoinControlAfterFee->setText(QString::fromUtf8("0.00 ADZ"));
        ...
        labelCoinControlChange->setText(QString::fromUtf8("0.00 ADZ"));
        ...
        labelBalance->setText(QString::fromUtf8("123.456 ADZ"));
...
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for adz transactions than the network can process.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for adz transactions than the network can process.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
