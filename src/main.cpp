...
uint256 hashGenesisBlock("0x00000f27bd42306ee2f582232a7fce3815c32a1f950d6d7f52ad2bbc560c2e66");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // AdzCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "AdzCoin Signed Message:\n";
...
{
    // AdzCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{		//digi shield implementation
   ...
   return pindexLast->nBits;
       ...
       // thanks to WDC for the basis of this code
...
{
    // AdzCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    // vMerkleTree: b0019d92bc054f7418960c91e252e7d24c77719c7a30128c5f6a827c73095d2a 
        ...
        assert(block.hashMerkleRoot == uint256("0xf852a09b11789c212e4915da0010c2f261214cd8993e55bae5edc04f31f764a9"));
...
unsigned char pchMessageStart[4] = { 0xfd, 0xc3, 0xb9, 0xde }; // AdzCoin: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("AdzCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("AdzCoinMiner : ProcessBlock, block not accepted");
    }
...
void static AdzCoinMiner(CWallet *pwallet)
{
    printf("AdzCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("AdzCoin-miner");
    ...
    try { loop {
        ...
        printf("Running AdzCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("AdzCoinMiner terminated\n");
        throw;
    }
}
...
void GenerateHashcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&AdzCoinMiner, pwallet));
}
