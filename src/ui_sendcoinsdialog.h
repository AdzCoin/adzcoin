...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QString::fromUtf8("0.00 DASH"));
        ...
        labelCoinControlFee->setText(QString::fromUtf8("0.00 DASH"));
        ...
        labelCoinControlAfterFee->setText(QString::fromUtf8("0.00 DASH"));
        ...
        labelCoinControlChange->setText(QString::fromUtf8("0.00 DASH"));
        ...
        checkUsePrivateSend->setObjectName(QString::fromUtf8("checkUsePrivateSend"));
        ...
        checkUseInstantSend->setObjectName(QString::fromUtf8("checkUseInstantSend"));
        ...
        labelBalance->setText(QString::fromUtf8("123.456 DASH"));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
...
#endif // QT_NO_TOOLTIP
        buttonMinimizeFee->setText(QApplication::translate("SendCoinsDialog", "Hide", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        radioCustomPerKilobyte->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 duffs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 duffs in fee,<br />while \"at least\" pays 1000 duffs. For transactions bigger than a kilobyte both pay by kilobyte.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        radioCustomPerKilobyte->setText(QApplication::translate("SendCoinsDialog", "per kilobyte", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        radioCustomAtLeast->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 duffs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 duffs in fee,<br />while \"total at least\" pays 1000 duffs. For transactions bigger than a kilobyte both pay by kilobyte.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        radioCustomAtLeast->setText(QApplication::translate("SendCoinsDialog", "total at least", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for dash transactions than the network can process.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for dash transactions than the network can process.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        ...
        checkUsePrivateSend->setText(QApplication::translate("SendCoinsDialog", "PrivateSend", 0, QApplication::UnicodeUTF8));
        checkUseInstantSend->setText(QApplication::translate("SendCoinsDialog", "InstantSend", 0, QApplication::UnicodeUTF8));
